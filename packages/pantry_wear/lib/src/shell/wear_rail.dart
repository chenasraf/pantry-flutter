...
class WearRail extends StatelessWidget {
  ...
  /// PROTOTYPE — which degraded-state treatment the rail is wearing, if any.
  /// See `prototype/degraded_proto.dart`.
  final DegradedProto? degraded;
  ...
  Widget build(BuildContext context) {
    ...
    // PROTOTYPE — A and D wash the whole rail; the rest draw inside it.
    final wash =
        degraded == DegradedProto.railTakeover ||
            degraded == DegradedProto.railLine
        ? protoDegradedGround.withValues(alpha: 0.55)
        : null;
    return ColoredBox(
      color: wash ?? const Color(0x00000000),
      child: Align(
        ...
        child: FractionallySizedBox(
          ...
          child: Column(
            ...
            children: [
              if (degraded == DegradedProto.railTakeover)
                ProtoDegradedTitleRow(onTap: onSetUpAgain)
              else
                GestureDetector(
                  onTap: onTapTitle,
                  ...
                  child: Row(
                    ...
                    children: [
                      if (degraded == DegradedProto.syncDot)
                        const ProtoDegradedDot()
                      else
                        const _SyncDot(),
              ...
              SizedBox(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: degraded == DegradedProto.railLine
                      ? ProtoDegradedRailLine(onTap: onSetUpAgain)
                      : expanded
