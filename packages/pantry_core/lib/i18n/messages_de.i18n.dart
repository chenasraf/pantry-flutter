...
class MessagesDe extends Messages {
  ...
  WidgetMessagesDe get widget => WidgetMessagesDe(this);
...
class WidgetMessagesDe extends WidgetMessages {
  final MessagesDe _parent;
  const WidgetMessagesDe(this._parent) : super(_parent);

  /// ```dart
  /// "Listen auswählen"
  /// ```
  String get chooseListsTitle => """Listen auswählen""";
...
class OnboardingMessagesDe extends OnboardingMessages {
  ...
  /// ```dart
  /// "Listen für dein Widget auswählen"
  /// ```
  String get widgetListsTitle => """Listen für dein Widget auswählen""";

  /// ```dart
  /// "Füge das Pantry-Widget zu deinem Startbildschirm hinzu, um auf einen Blick zu sehen, wie viele Einträge auf jeder Liste noch offen sind — ohne die App zu öffnen."
  /// ```
  String get widgetListsBody =>
      """Füge das Pantry-Widget zu deinem Startbildschirm hinzu, um auf einen Blick zu sehen, wie viele Einträge auf jeder Liste noch offen sind — ohne die App zu öffnen.""";

  /// ```dart
  /// "Beim Hinzufügen eines Widgets wählst du direkt seine Listen. Tippe später auf ${action}, um sie zu ändern, und füge beliebig viele Widgets hinzu — jedes mit eigenen Listen."
  /// ```
  ...
  /// "Listen auswählen"
  /// ```
  String get widgetListsActionLabel => """Listen auswählen""";
  ...
  /// "Alles erledigt"
  /// ```
  String get widgetListsWidgetEmpty => """Alles erledigt""";
...
class SettingsMessagesDe extends SettingsMessages {
  ...
  /// ```dart
  /// "Sprache, Design und Farben"
  /// ```
  String get generalSectionBody => """Sprache, Design und Farben""";
  ...
  /// ```dart
  /// "Navigation, Listen und Eintragsaktionen"
  /// ```
  ...
  /// "Listen"
  /// ```
  String get interfaceListsSection => """Listen""";

  /// ```dart
  /// "Eintragsaktionen"
  /// ```
  String get interfaceItemActionsSection => """Eintragsaktionen""";
  ...
  /// ```dart
  /// "Nextcloud-Designfarbe verwenden"
  /// ```
  String get useServerThemeColor => """Nextcloud-Designfarbe verwenden""";
  ...
  /// ```dart
  /// "Wie oft jeder Bildschirm nach Änderungen sucht"
  /// ```
...
class LabelsMessagesDe extends LabelsMessages {
  final MessagesDe _parent;
  const LabelsMessagesDe(this._parent) : super(_parent);

  /// ```dart
  /// "Etiketten verwalten"
  /// ```
  String get manageTitle => """Etiketten verwalten""";

  /// ```dart
  /// "Noch keine Etiketten."
  /// ```
  String get noLabels => """Noch keine Etiketten.""";

  /// ```dart
  /// "Etikett bearbeiten"
  /// ```
  String get editTitle => """Etikett bearbeiten""";

  /// ```dart
  /// "Neues Etikett"
  /// ```
  String get addTitle => """Neues Etikett""";
  ...
  /// ```dart
  /// "Etikett konnte nicht gespeichert werden."
  /// ```
  String get saveFailed => """Etikett konnte nicht gespeichert werden.""";

  /// ```dart
  /// "Etikett konnte nicht gelöscht werden."
  /// ```
  String get deleteFailed => """Etikett konnte nicht gelöscht werden.""";

  /// ```dart
  /// "Dieses Etikett löschen?"
  /// ```
  String get deleteConfirm => """Dieses Etikett löschen?""";

  /// ```dart
  /// "Dieses Etikett wird von allen Artikeln entfernt. Dies kann nicht rückgängig gemacht werden."
  /// ```
  String get deleteConfirmBody =>
      """Dieses Etikett wird von allen Artikeln entfernt. Dies kann nicht rückgängig gemacht werden.""";
  ...
  /// ```
  String get globalList => """Alle Listen (global)""";
  SortLabelsMessagesDe get sort => SortLabelsMessagesDe(this);
}

class SortLabelsMessagesDe extends SortLabelsMessages {
  final LabelsMessagesDe _parent;
  const SortLabelsMessagesDe(this._parent) : super(_parent);
...
class FiltersChecklistsMessagesDe extends FiltersChecklistsMessages {
  ...
  /// "Alle Etiketten"
  /// ```
  String get allLabels => """Alle Etiketten""";
  ...
  /// "Kein Etikett"
  /// ```
  String get noLabels => """Kein Etikett""";
...
class BatchChecklistsMessagesDe extends BatchChecklistsMessages {
  ...
  /// "Etiketten festlegen"
  /// ```
  String get labelsTitle => """Etiketten festlegen""";
...
class ItemFormChecklistsMessagesDe extends ItemFormChecklistsMessages {
  ...
  /// "Neues Etikett"
  /// ```
  String get createLabel => """Neues Etikett""";

  /// ```dart
  /// "Ändern"
  /// ```
  String get labelsChange => """Ändern""";

  /// ```dart
  /// "Auswählen"
  /// ```
  String get labelsPick => """Auswählen""";
...
class ComposeChecklistsMessagesDe extends ComposeChecklistsMessages {
  ...
  /// "Etiketten"
  /// ```
  String get chipLabel => """Etiketten""";
...
class MarkdownChecklistsMessagesDe extends MarkdownChecklistsMessages {
  ...
  /// "Importieren nach"
  /// ```
  String get importToLabel => """Importieren nach""";
...
class NotesWallMessagesDe extends NotesWallMessages {
  ...
  /// ```
  String get importToList => """In Liste importieren""";

  /// ```dart
  /// "Keine Listen zum Importieren verfügbar."
  /// ```
  String get importNoLists => """Keine Listen zum Importieren verfügbar.""";

  /// ```dart
  /// "Synchronisiert mit ${path}"
  /// ```
  String syncedToFile(String path) => """Synchronisiert mit ${path}""";

  /// ```dart
  /// "Synchronisierte Datei fehlt"
  /// ```
  String get syncedFileMissing => """Synchronisierte Datei fehlt""";

  /// ```dart
  /// "Synchronisiert ${when}"
  /// ```
  String syncedAt(String when) => """Synchronisiert ${when}""";
...
class ShoppingMessagesDe extends ShoppingMessages {
  ...
  /// "Zu kaufende Artikel"
  /// ```
  String get itemsToShop => """Zu kaufende Artikel""";

  /// ```dart
  /// "${_plural(count, one: 'Alle 1 Artikel', many: 'Alle $count Artikel')}"
  /// ```
  String allItemsPicked(int count) =>
      """${_plural(count, one: 'Alle 1 Artikel', many: 'Alle $count Artikel')}""";

  /// ```dart
  /// "$picked von $total Artikeln"
  /// ```
  ...
  /// "Umkehren"
  /// ```
  String get selectInvert => """Umkehren""";

  /// ```dart
  /// "In den ausgewählten Listen ist nichts mehr zu kaufen."
  /// ```
  String get noItemsToShop =>
      """In den ausgewählten Listen ist nichts mehr zu kaufen.""";

  /// ```dart
  /// "Wähle mindestens einen Artikel zum Kaufen aus."
  /// ```
...
class MarkdownEditorMessagesDe extends MarkdownEditorMessages {
  final MessagesDe _parent;
  const MarkdownEditorMessagesDe(this._parent) : super(_parent);
...
class WearMessagesDe extends WearMessages {
  final MessagesDe _parent;
  const WearMessagesDe(this._parent) : super(_parent);

  /// ```dart
  /// "Angemeldet als ${name}"
  /// ```
  String signedInAs(String name) => """Angemeldet als ${name}""";
  ...
  /// "Noch $count"
  /// ```
  String tasksLeft(int count) => """Noch $count""";
  ...
  /// "Privater Einkauf"
  /// ```
  String get privateTrip => """Privater Einkauf""";

  /// ```dart
  /// "Braucht eine Verbindung"
  /// ```
  String get needsConnection => """Braucht eine Verbindung""";

  /// ```dart
  /// "Server braucht WLAN"
  /// ```
  String get needsWifi => """Server braucht WLAN""";

  /// ```dart
  /// "Erst eine Liste wählen"
  /// ```
  String get pickAList => """Erst eine Liste wählen""";

  /// ```dart
  /// "$count ausgewählt"
  /// ```
  String nSelected(int count) => """$count ausgewählt""";
...
Bitte melde dich in deinem Browser an.""",
  ...
  """onboarding.progressHeroDismissBody""":
      """Brauchst du den Fortschrittsring oben nicht? Klicke auf das X auf der Karte, um sie auszublenden.""",
  """onboarding.widgetListsTitle""": """Listen für dein Widget auswählen""",
  """onboarding.widgetListsBody""":
      """Füge das Pantry-Widget zu deinem Startbildschirm hinzu, um auf einen Blick zu sehen, wie viele Einträge auf jeder Liste noch offen sind — ohne die App zu öffnen.""",
  """onboarding.widgetListsActionLabel""": """Listen auswählen""",
  """onboarding.widgetListsWidgetTitle""": """Pantry""",
  """onboarding.widgetListsWidgetEmpty""": """Alles erledigt""",
...
Passwort: pantry-rocks""",
  ...
  """settings.generalSectionBody""": """Sprache, Design und Farben""",
  ...
  """labels.manageTitle""": """Etiketten verwalten""",
  """labels.noLabels""": """Noch keine Etiketten.""",
  """labels.editTitle""": """Etikett bearbeiten""",
  """labels.addTitle""": """Neues Etikett""",
  """labels.name""": """Name""",
  """labels.icon""": """Symbol""",
  """labels.color""": """Farbe""",
  """labels.saveFailed""": """Etikett konnte nicht gespeichert werden.""",
  """labels.deleteFailed""": """Etikett konnte nicht gelöscht werden.""",
  """labels.deleteConfirm""": """Dieses Etikett löschen?""",
  """labels.deleteConfirmBody""":
      """Dieses Etikett wird von allen Artikeln entfernt. Dies kann nicht rückgängig gemacht werden.""",
  """labels.list""": """Liste""",
  """labels.globalList""": """Alle Listen (global)""",
  """labels.sort.nameAZ""": """Name A–Z""",
  """labels.sort.nameZA""": """Name Z–A""",
  """labels.sort.custom""": """Benutzerdefiniert""",
  ...
  """checklists.filters.labels""": """Etiketten""",
  ...
  """checklists.batch.labelsTitle""": """Etiketten festlegen""",
  ...
  """checklists.batch.labels""": """Etiketten""",
  ...
  """checklists.itemForm.labels""": """Etiketten""",
  """checklists.itemForm.noLabels""": """Keine""",
  """checklists.itemForm.createLabel""": """Neues Etikett""",
  """checklists.itemForm.labelsChange""": """Ändern""",
  """checklists.itemForm.labelsPick""": """Auswählen""",
  ...
  """checklists.markdown.importToLabel""": """Importieren nach""",
  ...
  """notesWall.importToList""": """In Liste importieren""",
  """notesWall.importNoLists""": """Keine Listen zum Importieren verfügbar.""",
  """notesWall.syncedFileMissing""": """Synchronisierte Datei fehlt""",
  ...
  """shopping.itemsToShop""": """Zu kaufende Artikel""",
  """shopping.selectInvert""": """Umkehren""",
  ...
  """wear.sessionExpiredShort""":
      """Dein Telefon muss diese Uhr erneut anmelden.""",
  """wear.privateTrip""": """Privater Einkauf""",
  """wear.needsConnection""": """Braucht eine Verbindung""",
  """wear.needsWifi""": """Server braucht WLAN""",
