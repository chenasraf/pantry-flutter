...
class MessagesHe extends Messages {
  ...
  WatchTipsMessagesHe get watchTips => WatchTipsMessagesHe(this);
}
...
class SettingsMessagesHe extends SettingsMessages {
  ...
  /// ```dart
  /// "כמה מקום כל פריט תופס ברשימות שלך."
  /// ```
  String get densityBody => """כמה מקום כל פריט תופס ברשימות שלך.""";
  DensityNamesSettingsMessagesHe get densityNames =>
  ...
  /// ```dart
  /// "קיצור שמות פריטים ארוכים"
  /// ```
  String get truncateItemNames => """קיצור שמות פריטים ארוכים""";
  ...
  /// ```dart
  /// "גרור כדי לשנות את סדר הלשוניות. הקטע הגלוי הראשון נפתח עם הפעלת האפליקציה. כבה כל קטע שאינך משתמש בו כדי להסתיר את הלשונית שלו — לפחות אחד חייב להישאר פעיל."
  /// ```
  ...
  /// "סנכרון הבית הפתוח"
  /// ```
  String get syncLastHouse => """סנכרון הבית הפתוח""";

  /// ```dart
  /// "פתיחת הבית שהשתמשת בו לאחרונה בכל מכשיר, ומתן אפשרות לאפליקציית הרשת ולשאר המכשירים שלך לעקוב אחרי המכשיר הזה. כבה כדי לשמור כאן בית משלך."
  /// ```
...
class DensityNamesSettingsMessagesHe extends DensityNamesSettingsMessages {
  final SettingsMessagesHe _parent;
  const DensityNamesSettingsMessagesHe(this._parent) : super(_parent);
...
class WearMessagesHe extends WearMessages {
  final MessagesHe _parent;
  const WearMessagesHe(this._parent) : super(_parent);

  /// ```dart
  /// "מחובר בתור ${name}"
  /// ```
  String signedInAs(String name) => """מחובר בתור ${name}""";
...
class WatchTipsMessagesHe extends WatchTipsMessages {
  final MessagesHe _parent;
  const WatchTipsMessagesHe(this._parent) : super(_parent);

  /// ```dart
  /// "טיפים"
  /// ```
  String get section => """טיפים""";

  /// ```dart
  /// "הסברים קצרים על אופן העבודה עם אפליקציית השעון."
  /// ```
  ...
  /// "שלב אחר שלב"
  /// ```
  String get stepsLabel => """שלב אחר שלב""";

  /// ```dart
  /// "הגדרת השעון"
  /// ```
  String get pairTitle => """הגדרת השעון""";

  /// ```dart
  /// "חיבור השעון דרך הטלפון הזה"
  /// ```
  String get pairSubtitle => """חיבור השעון דרך הטלפון הזה""";

  /// ```dart
  /// "שעון הוא מקום גרוע להקליד בו סיסמה, ולכן הוא לווה את ההתחברות מהטלפון הזה. שום דבר לא מוקלד על פרק היד."
  /// ```
  String get pairBody =>
      """שעון הוא מקום גרוע להקליד בו סיסמה, ולכן הוא לווה את ההתחברות מהטלפון הזה. שום דבר לא מוקלד על פרק היד.""";

  /// ```dart
  /// "פתח את Pantry בשעון. יופיע מסך הגדרה."
  /// ```
  String get pairStep1 => """פתח את Pantry בשעון. יופיע מסך הגדרה.""";

  /// ```dart
  /// "הקש על ״פתיחה בטלפון״. השעון מבקש מהטלפון הזה להשתלט."
  /// ```
  String get pairStep2 =>
      """הקש על ״פתיחה בטלפון״. השעון מבקש מהטלפון הזה להשתלט.""";

  /// ```dart
  /// "שחרר את נעילת הטלפון והקש ״אישור״ על הבקשה שתופיע כאן."
  /// ```
  String get pairStep3 =>
      """שחרר את נעילת הטלפון והקש ״אישור״ על הבקשה שתופיע כאן.""";

  /// ```dart
  /// "השאר את המסך הזה פתוח עד שייכתב שהשעון מחובר."
  /// ```
  String get pairStep4 => """השאר את המסך הזה פתוח עד שייכתב שהשעון מחובר.""";

  /// ```dart
  /// "אין טלפון בהישג יד? השעון יכול להציג קוד QR במקום. סרוק אותו בכל מצלמה והשלם את ההתחברות בדפדפן שנפתח."
  /// ```
  String get pairNote =>
      """אין טלפון בהישג יד? השעון יכול להציג קוד QR במקום. סרוק אותו בכל מצלמה והשלם את ההתחברות בדפדפן שנפתח.""";
  ...
  /// "סימון פריטים"
  /// ```
  String get itemsTitle => """סימון פריטים""";

  /// ```dart
  /// "הקשה מסמנת, לחיצה ארוכה פותחת פרטים"
  /// ```
  String get itemsSubtitle => """הקשה מסמנת, לחיצה ארוכה פותחת פרטים""";

  /// ```dart
  /// "השורה שבמרכז המסך היא זו שההקשה פועלת עליה. כל מה שאפשר לעשות לפריט תלוי בשורה הזו."
  /// ```
  String get itemsBody =>
      """השורה שבמרכז המסך היא זו שההקשה פועלת עליה. כל מה שאפשר לעשות לפריט תלוי בשורה הזו.""";

  /// ```dart
  /// "הקש על השורה המרכזית כדי לסמן אותה. הקשה נוספת מחזירה אותה."
  /// ```
  String get itemsStep1 =>
      """הקש על השורה המרכזית כדי לסמן אותה. הקשה נוספת מחזירה אותה.""";

  /// ```dart
  /// "סביב השורה מתרוקנת טבעת כל עוד אפשר לבטל את השינוי. הקשה נוספת בתוך החלון הזה מבטלת, ושום דבר לא נכתב."
  /// ```
  String get itemsStep2 =>
      """סביב השורה מתרוקנת טבעת כל עוד אפשר לבטל את השינוי. הקשה נוספת בתוך החלון הזה מבטלת, ושום דבר לא נכתב.""";

  /// ```dart
  /// "לחיצה ארוכה על שורה פותחת אותה. כמות, מחיר, קטגוריה והערות נמצאים שם, לצד כפתור שפותח את הפריט בטלפון הזה."
  /// ```
  String get itemsStep3 =>
      """לחיצה ארוכה על שורה פותחת אותה. כמות, מחיר, קטגוריה והערות נמצאים שם, לצד כפתור שפותח את הפריט בטלפון הזה.""";

  /// ```dart
  /// "הקשה על שורה שאינה במרכז רק מביאה אותה למרכז. ההקשה הבאה היא זו שפועלת, כך שפספוס עולה גלילה בלבד."
  /// ```
  ...
  /// "התמצאות באפליקציה"
  /// ```
  String get pagesTitle => """התמצאות באפליקציה""";

  /// ```dart
  /// "החלקה בין עמודים, החלקה החוצה"
  /// ```
  String get pagesSubtitle => """החלקה בין עמודים, החלקה החוצה""";

  /// ```dart
  /// "אפליקציית השעון היא שורה של עמודים במסך מלא תחת כותרת אחת. אין תפריט לפתוח."
  /// ```
  String get pagesBody =>
      """אפליקציית השעון היא שורה של עמודים במסך מלא תחת כותרת אחת. אין תפריט לפתוח.""";

  /// ```dart
  /// "החלק לצדדים כדי לעבור בין הרשימה, לוח התמונות, קיר הפתקים ועמוד החשבון."
  /// ```
  String get pagesStep1 =>
      """החלק לצדדים כדי לעבור בין הרשימה, לוח התמונות, קיר הפתקים ועמוד החשבון.""";

  /// ```dart
  /// "הפסים שמתחת לכותרת מראים כמה עמודים יש ובאיזה אתה נמצא."
  /// ```
  String get pagesStep2 =>
      """הפסים שמתחת לכותרת מראים כמה עמודים יש ובאיזה אתה נמצא.""";

  /// ```dart
  /// "החלק פנימה משולי המסך כדי לצאת מכל דבר שפתחת."
  /// ```
  String get pagesStep3 => """החלק פנימה משולי המסך כדי לצאת מכל דבר שפתחת.""";

  /// ```dart
  /// "הכותרת תמיד מציינת את העמוד שאתה בו, והשורה שמתחתיה את הקבוצה שאליה שייכת השורה המרכזית."
  /// ```
  ...
  /// "החלפת רשימה"
  /// ```
  String get listsTitle => """החלפת רשימה""";

  /// ```dart
  /// "הקש על הכותרת שלמעלה"
  /// ```
  String get listsSubtitle => """הקש על הכותרת שלמעלה""";

  /// ```dart
  /// "השם שבראש המסך הוא כפתור. הקשה עליו פותחת את שני הדברים שבשבילם עוזבים רשימה."
  /// ```
  String get listsBody =>
      """השם שבראש המסך הוא כפתור. הקשה עליו פותחת את שני הדברים שבשבילם עוזבים רשימה.""";

  /// ```dart
  /// "הקש על שם הרשימה בראש המסך."
  /// ```
  String get listsStep1 => """הקש על שם הרשימה בראש המסך.""";

  /// ```dart
  /// "מתחתיו נפתחים שני כפתורים, ״התחלת קניות״ ו״החלפת רשימה״."
  /// ```
  String get listsStep2 =>
      """מתחתיו נפתחים שני כפתורים, ״התחלת קניות״ ו״החלפת רשימה״.""";

  /// ```dart
  /// "הקש ״החלפת רשימה״ ובחר אחרת, או ״כל הרשימות״ כדי לראות הכול בבת אחת."
  /// ```
  String get listsStep3 =>
      """הקש ״החלפת רשימה״ ובחר אחרת, או ״כל הרשימות״ כדי לראות הכול בבת אחת.""";

  /// ```dart
  /// "הכפתורים נסגרים מעצמם אחרי כמה שניות, כך שהקשה מקרית על הכותרת לא עולה דבר."
  /// ```
  ...
  /// "יציאה לקנייה"
  /// ```
  String get shoppingTitle => """יציאה לקנייה""";

  /// ```dart
  /// "מעבר בין חנויות כשהטלפון בכיס"
  /// ```
  String get shoppingSubtitle => """מעבר בין חנויות כשהטלפון בכיס""";

  /// ```dart
  /// "קנייה הופכת את השעון ללוויין קניות. העמודים נעשים אלה שצריך במעבר בין המדפים, ובני הבית יכולים לעקוב."
  /// ```
  String get shoppingBody =>
      """קנייה הופכת את השעון ללוויין קניות. העמודים נעשים אלה שצריך במעבר בין המדפים, ובני הבית יכולים לעקוב.""";

  /// ```dart
  /// "הקש על הכותרת ואז על ״התחלת קניות״. בחר את הרשימות, את החנויות, והאם בני הבית רואים את הקנייה."
  /// ```
  String get shoppingStep1 =>
      """הקש על הכותרת ואז על ״התחלת קניות״. בחר את הרשימות, את החנויות, והאם בני הבית רואים את הקנייה.""";

  /// ```dart
  /// "העמודים נעשים הקנייה עצמה, אחד להתקדמות, אחד לרשימה, אחד למה שנקנה ואחד למה שדולג."
  /// ```
  String get shoppingStep2 =>
      """העמודים נעשים הקנייה עצמה, אחד להתקדמות, אחד לרשימה, אחד למה שנקנה ואחד למה שדולג.""";

  /// ```dart
  /// "סמן תוך כדי הליכה. מה שדולג עובר לעמוד משלו וחוזר לרשימה בהקשה."
  /// ```
  String get shoppingStep3 =>
      """סמן תוך כדי הליכה. מה שדולג עובר לעמוד משלו וחוזר לרשימה בהקשה.""";

  /// ```dart
  /// "ביציאה מחנות השעון שואל כמה חייבה הקופה וממשיך אותך לחנות הבאה."
  /// ```
  String get shoppingStep4 =>
      """ביציאה מחנות השעון שואל כמה חייבה הקופה וממשיך אותך לחנות הבאה.""";

  /// ```dart
  /// "אחרי החנות האחרונה, ״סיום הקנייה״ מציג את הסיכום לפני שנסגר משהו."
  /// ```
  String get shoppingStep5 =>
      """אחרי החנות האחרונה, ״סיום הקנייה״ מציג את הסיכום לפני שנסגר משהו.""";

  /// ```dart
  /// "הקשה על חנות בעמוד ההתקדמות מעבירה את הקנייה ישירות אליה, אחורה בדיוק כמו קדימה, כך שטעות היא תיקון ולא התחלה מחדש."
  /// ```
  ...
  /// "סיבוב הכתר"
  /// ```
  String get crownTitle => """סיבוב הכתר""";

  /// ```dart
  /// "גלילת הרשימה, או מעבר בין עמודים"
  /// ```
  String get crownSubtitle => """גלילת הרשימה, או מעבר בין עמודים""";

  /// ```dart
  /// "סיבוב הכתר או המסגרת המסתובבת גולל את הרשימה שלפניך, ומשאיר את האצבע מחוץ למה שאתה קורא."
  /// ```
  String get crownBody =>
      """סיבוב הכתר או המסגרת המסתובבת גולל את הרשימה שלפניך, ומשאיר את האצבע מחוץ למה שאתה קורא.""";

  /// ```dart
  /// "סובב את הכתר כדי לעבור בין שורות הרשימה. השורה שהוא עוצר בה היא זו שהקשה פועלת עליה."
  /// ```
  String get crownStep1 =>
      """סובב את הכתר כדי לעבור בין שורות הרשימה. השורה שהוא עוצר בה היא זו שהקשה פועלת עליה.""";

  /// ```dart
  /// "כדי שסיבוב יעביר עמודים במקום, פתח בשעון ״חשבון״, ואז ״הגדרות״, ואז ״כתר״."
  /// ```
  String get crownStep2 =>
      """כדי שסיבוב יעביר עמודים במקום, פתח בשעון ״חשבון״, ואז ״הגדרות״, ואז ״כתר״.""";

  /// ```dart
  /// "סיבוב עושה דבר אחד בכל רגע. מסירת הכתר לעמודים אומרת שרשימות נגללות באצבע בלבד."
  /// ```
  ...
  /// "עובד גם בלי קליטה"
  /// ```
  String get offlineTitle => """עובד גם בלי קליטה""";

  /// ```dart
  /// "אפשר להמשיך לסמן במקרר הקפוא"
  /// ```
  String get offlineSubtitle => """אפשר להמשיך לסמן במקרר הקפוא""";

  /// ```dart
  /// "השעון שומר עותק משלו של הבית, ולכן הוא נפתח ועובד גם כששום דבר לא בטווח. בלי טלפון, בלי רשת אלחוטית ובלי חבילת גלישה לשעון."
  /// ```
  String get offlineBody =>
      """השעון שומר עותק משלו של הבית, ולכן הוא נפתח ועובד גם כששום דבר לא בטווח. בלי טלפון, בלי רשת אלחוטית ובלי חבילת גלישה לשעון.""";

  /// ```dart
  /// "נקודה קטנה בראש המסך אומרת שכל מה שעשית נשמר."
  /// ```
  String get offlineStep1 =>
      """נקודה קטנה בראש המסך אומרת שכל מה שעשית נשמר.""";

  /// ```dart
  /// "ענן עם מספר לצדו אומר שכמות כזו של שינויים ממתינה לחיבור."
  /// ```
  String get offlineStep2 =>
      """ענן עם מספר לצדו אומר שכמות כזו של שינויים ממתינה לחיבור.""";

  /// ```dart
  /// "הם יוצאים מעצמם ברגע שהשעון חוזר לטווח. אין מה ללחוץ."
  /// ```
  String get offlineStep3 =>
      """הם יוצאים מעצמם ברגע שהשעון חוזר לטווח. אין מה ללחוץ.""";

  /// ```dart
  /// "רשימה במרחק החלקה אחת"
  /// ```
  String get tileTitle => """רשימה במרחק החלקה אחת""";

  /// ```dart
  /// "הוספת האריח של Pantry"
  /// ```
  String get tileSubtitle => """הוספת האריח של Pantry""";

  /// ```dart
  /// "אריחים הם המסכים שליד לוח השעון. Pantry מפרסמת אריח שמציג את שמות הרשימות שלך, כך שרשימה נמצאת במרחק החלקה ולא במרחק פתיחת אפליקציה."
  /// ```
  String get tileBody =>
      """אריחים הם המסכים שליד לוח השעון. Pantry מפרסמת אריח שמציג את שמות הרשימות שלך, כך שרשימה נמצאת במרחק החלקה ולא במרחק פתיחת אפליקציה.""";

  /// ```dart
  /// "מלוח השעון, החלק לצדדים עד שתגיע לאריחים."
  /// ```
  String get tileStep1 => """מלוח השעון, החלק לצדדים עד שתגיע לאריחים.""";

  /// ```dart
  /// "לחץ לחיצה ארוכה, הקש על הפלוס, ובחר את Pantry מהרשימה."
  /// ```
  String get tileStep2 =>
      """לחץ לחיצה ארוכה, הקש על הפלוס, ובחר את Pantry מהרשימה.""";

  /// ```dart
  /// "הקש על רשימה באריח כדי לפתוח את האפליקציה ישירות עליה."
  /// ```
...
סיסמה: pantry-rocks""",
  ...
  """settings.useServerThemeColorBody""":
      """צביעת האפליקציה בצבע ערכת הנושא של משתמש ה-Nextcloud שלך. כבה כדי להשתמש בצבעים של האפליקציה עצמה.""",
  """settings.syncLastHouse""": """סנכרון הבית הפתוח""",
  ...
  """watch.unpairBody""":
      """השעון יתנתק וישכח את הבית שלך. אפשר להגדיר אותו מחדש בכל עת.""",
  """watchTips.section""": """טיפים""",
  """watchTips.sectionBody""":
      """הסברים קצרים על אופן העבודה עם אפליקציית השעון.""",
  """watchTips.stepsLabel""": """שלב אחר שלב""",
  """watchTips.pairTitle""": """הגדרת השעון""",
  """watchTips.pairSubtitle""": """חיבור השעון דרך הטלפון הזה""",
  """watchTips.pairBody""":
      """שעון הוא מקום גרוע להקליד בו סיסמה, ולכן הוא לווה את ההתחברות מהטלפון הזה. שום דבר לא מוקלד על פרק היד.""",
  """watchTips.pairStep1""": """פתח את Pantry בשעון. יופיע מסך הגדרה.""",
  """watchTips.pairStep2""":
      """הקש על ״פתיחה בטלפון״. השעון מבקש מהטלפון הזה להשתלט.""",
  """watchTips.pairStep3""":
      """שחרר את נעילת הטלפון והקש ״אישור״ על הבקשה שתופיע כאן.""",
  ...
  """watchTips.pairNote""":
      """אין טלפון בהישג יד? השעון יכול להציג קוד QR במקום. סרוק אותו בכל מצלמה והשלם את ההתחברות בדפדפן שנפתח.""",
  """watchTips.itemsTitle""": """סימון פריטים""",
  """watchTips.itemsSubtitle""": """הקשה מסמנת, לחיצה ארוכה פותחת פרטים""",
  """watchTips.itemsBody""":
      """השורה שבמרכז המסך היא זו שההקשה פועלת עליה. כל מה שאפשר לעשות לפריט תלוי בשורה הזו.""",
  ...
  """watchTips.itemsNote""":
      """הקשה על שורה שאינה במרכז רק מביאה אותה למרכז. ההקשה הבאה היא זו שפועלת, כך שפספוס עולה גלילה בלבד.""",
  """watchTips.pagesTitle""": """התמצאות באפליקציה""",
  """watchTips.pagesSubtitle""": """החלקה בין עמודים, החלקה החוצה""",
  """watchTips.pagesBody""":
      """אפליקציית השעון היא שורה של עמודים במסך מלא תחת כותרת אחת. אין תפריט לפתוח.""",
  ...
  """watchTips.pagesNote""":
      """הכותרת תמיד מציינת את העמוד שאתה בו, והשורה שמתחתיה את הקבוצה שאליה שייכת השורה המרכזית.""",
  """watchTips.listsTitle""": """החלפת רשימה""",
  """watchTips.listsSubtitle""": """הקש על הכותרת שלמעלה""",
  """watchTips.listsBody""":
      """השם שבראש המסך הוא כפתור. הקשה עליו פותחת את שני הדברים שבשבילם עוזבים רשימה.""",
  """watchTips.listsStep1""": """הקש על שם הרשימה בראש המסך.""",
  ...
  """watchTips.listsNote""":
      """הכפתורים נסגרים מעצמם אחרי כמה שניות, כך שהקשה מקרית על הכותרת לא עולה דבר.""",
  """watchTips.shoppingTitle""": """יציאה לקנייה""",
  """watchTips.shoppingSubtitle""": """מעבר בין חנויות כשהטלפון בכיס""",
  ...
  """watchTips.shoppingNote""":
      """הקשה על חנות בעמוד ההתקדמות מעבירה את הקנייה ישירות אליה, אחורה בדיוק כמו קדימה, כך שטעות היא תיקון ולא התחלה מחדש.""",
  """watchTips.crownTitle""": """סיבוב הכתר""",
  """watchTips.crownSubtitle""": """גלילת הרשימה, או מעבר בין עמודים""",
  """watchTips.crownBody""":
      """סיבוב הכתר או המסגרת המסתובבת גולל את הרשימה שלפניך, ומשאיר את האצבע מחוץ למה שאתה קורא.""",
  ...
  """watchTips.crownNote""":
      """סיבוב עושה דבר אחד בכל רגע. מסירת הכתר לעמודים אומרת שרשימות נגללות באצבע בלבד.""",
  """watchTips.offlineTitle""": """עובד גם בלי קליטה""",
  """watchTips.offlineSubtitle""": """אפשר להמשיך לסמן במקרר הקפוא""",
  ...
  """watchTips.offlineStep3""":
      """הם יוצאים מעצמם ברגע שהשעון חוזר לטווח. אין מה ללחוץ.""",
  """watchTips.tileTitle""": """רשימה במרחק החלקה אחת""",
  """watchTips.tileSubtitle""": """הוספת האריח של Pantry""",
  """watchTips.tileBody""":
      """אריחים הם המסכים שליד לוח השעון. Pantry מפרסמת אריח שמציג את שמות הרשימות שלך, כך שרשימה נמצאת במרחק החלקה ולא במרחק פתיחת אפליקציה.""",
  """watchTips.tileStep1""": """מלוח השעון, החלק לצדדים עד שתגיע לאריחים.""",
  """watchTips.tileStep2""":
      """לחץ לחיצה ארוכה, הקש על הפלוס, ובחר את Pantry מהרשימה.""",
  """watchTips.tileStep3""":
      """הקש על רשימה באריח כדי לפתוח את האפליקציה ישירות עליה.""",
