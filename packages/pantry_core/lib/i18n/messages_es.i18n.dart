...
class MessagesEs extends Messages {
  ...
  WidgetMessagesEs get widget => WidgetMessagesEs(this);
...
class WidgetMessagesEs extends WidgetMessages {
  final MessagesEs _parent;
  const WidgetMessagesEs(this._parent) : super(_parent);

  /// ```dart
  /// "Elegir listas"
  /// ```
  String get chooseListsTitle => """Elegir listas""";

  /// ```dart
  /// "Elige qué listas muestra este widget."
  /// ```
...
class OnboardingMessagesEs extends OnboardingMessages {
  ...
  /// ```dart
  /// "Elige las listas de tu widget"
  /// ```
  String get widgetListsTitle => """Elige las listas de tu widget""";

  /// ```dart
  /// "Añade el widget de Pantry a tu pantalla de inicio para ver de un vistazo cuántos artículos quedan en cada lista, sin abrir la app."
  /// ```
  String get widgetListsBody =>
      """Añade el widget de Pantry a tu pantalla de inicio para ver de un vistazo cuántos artículos quedan en cada lista, sin abrir la app.""";

  /// ```dart
  /// "Al añadir un widget eliges sus listas al momento. Toca ${action} en un widget para cambiarlas después y añade tantos widgets como quieras, cada uno con sus propias listas."
  /// ```
  ...
  /// "Elegir listas"
  /// ```
  String get widgetListsActionLabel => """Elegir listas""";
  ...
  /// "Todo hecho"
  /// ```
  String get widgetListsWidgetEmpty => """Todo hecho""";
...
Contraseña: pantry-rocks""";
  ...
  /// ```dart
  /// "Añade precios a tus artículos"
  /// ```
  String get priceTitle => """Añade precios a tus artículos""";
  ...
  /// ```dart
  /// "Categorías por lista"
  /// ```
  String get categoryScopeTitle => """Categorías por lista""";

  /// ```dart
  /// "Mantén una categoría en una sola lista, o hazla global para que aparezca en todas las listas. Las categorías nuevas siguen siendo globales a menos que elijas una lista."
  /// ```
  ...
  /// ```
  String get categoryScopeGlobalCaption => """Aparece en todas las listas""";

  /// ```dart
  /// "Aparece solo en esta lista"
  /// ```
...
class SettingsMessagesEs extends SettingsMessages {
  ...
  /// ```dart
  /// "Usar el color del tema de Nextcloud"
  /// ```
  String get useServerThemeColor => """Usar el color del tema de Nextcloud""";
  ...
  /// ```
  String get refreshSection => """Actualización automática""";
  ...
  /// "Listas"
  /// ```
  String get checklistRefresh => """Listas""";

  /// ```dart
  /// "Notas"
  /// ```
  String get notesRefresh => """Notas""";
  ...
  /// "Modo compra"
  /// ```
  String get shoppingRefresh => """Modo compra""";
  ...
  /// ```
  String get refreshInherit => """Igual que las listas""";

  /// ```dart
  /// "Cada 15 segundos"
  /// ```
  String get refresh15s => """Cada 15 segundos""";

  /// ```dart
  /// "Cada 30 segundos"
  /// ```
  String get refresh30s => """Cada 30 segundos""";

  /// ```dart
  /// "Cada minuto"
  /// ```
  String get refresh1m => """Cada minuto""";

  /// ```dart
  /// "Cada 2 minutos"
  /// ```
  String get refresh2m => """Cada 2 minutos""";
...
class StoresMessagesEs extends StoresMessages {
  ...
  SortStoresMessagesEs get sort => SortStoresMessagesEs(this);
}

class SortStoresMessagesEs extends SortStoresMessages {
  final StoresMessagesEs _parent;
  const SortStoresMessagesEs(this._parent) : super(_parent);
...
class LabelsMessagesEs extends LabelsMessages {
  final MessagesEs _parent;
  const LabelsMessagesEs(this._parent) : super(_parent);

  /// ```dart
  /// "Gestionar etiquetas"
  /// ```
  String get manageTitle => """Gestionar etiquetas""";
  ...
  /// "Editar etiqueta"
  /// ```
  String get editTitle => """Editar etiqueta""";

  /// ```dart
  /// "Nueva etiqueta"
  /// ```
  String get addTitle => """Nueva etiqueta""";
  ...
  /// ```
  String get saveFailed => """No se pudo guardar la etiqueta.""";

  /// ```dart
  /// "No se pudo eliminar la etiqueta."
  /// ```
  String get deleteFailed => """No se pudo eliminar la etiqueta.""";

  /// ```dart
  /// "¿Eliminar esta etiqueta?"
  /// ```
  String get deleteConfirm => """¿Eliminar esta etiqueta?""";

  /// ```dart
  /// "Esta etiqueta se eliminará de todos los artículos. Esto no se puede deshacer."
  /// ```
  String get deleteConfirmBody =>
      """Esta etiqueta se eliminará de todos los artículos. Esto no se puede deshacer.""";
  ...
  /// ```
  String get globalList => """Todas las listas (global)""";
  SortLabelsMessagesEs get sort => SortLabelsMessagesEs(this);
}

class SortLabelsMessagesEs extends SortLabelsMessages {
  final LabelsMessagesEs _parent;
  const SortLabelsMessagesEs(this._parent) : super(_parent);
...
class ChecklistsMessagesEs extends ChecklistsMessages {
  ...
  /// ```dart
  /// "¿Desmarcar todos los artículos?"
  /// ```
  String get uncheckAllConfirm => """¿Desmarcar todos los artículos?""";
  ...
  PriceChecklistsMessagesEs get price => PriceChecklistsMessagesEs(this);
...
class FiltersChecklistsMessagesEs extends FiltersChecklistsMessages {
  ...
  /// "Sin etiqueta"
  /// ```
  String get noLabels => """Sin etiqueta""";
  ...
  /// "Cualquier moneda"
  /// ```
  String get anyCurrency => """Cualquier moneda""";
}
...
class BatchChecklistsMessagesEs extends BatchChecklistsMessages {
  ...
  /// ```
  String get labelsTitle => """Establecer etiquetas""";
...
class ItemFormChecklistsMessagesEs extends ItemFormChecklistsMessages {
  ...
  /// "Ninguna"
  /// ```
  String get noLabels => """Ninguna""";

  /// ```dart
  /// "Nueva etiqueta"
  /// ```
  String get createLabel => """Nueva etiqueta""";

  /// ```dart
  /// "Cambiar"
  /// ```
  String get labelsChange => """Cambiar""";

  /// ```dart
  /// "Elegir"
  /// ```
  String get labelsPick => """Elegir""";
...
class ResetOrderChecklistsMessagesEs extends ResetOrderChecklistsMessages {
  final ChecklistsMessagesEs _parent;
  const ResetOrderChecklistsMessagesEs(this._parent) : super(_parent);

  /// ```dart
  /// "Restablecer orden personalizado…"
  /// ```
  String get menuLabel => """Restablecer orden personalizado…""";

  /// ```dart
  /// "Restablecer orden personalizado a…"
  /// ```
  String get pickTitle => """Restablecer orden personalizado a…""";

  /// ```dart
  /// "¿Restablecer orden personalizado?"
  /// ```
  String get confirmTitle => """¿Restablecer orden personalizado?""";

  /// ```dart
  /// "Esto sobrescribe el orden personalizado actual de esta lista. Puedes reordenar los artículos después."
  /// ```
  ...
  /// "Restablecer orden"
  /// ```
  String get action => """Restablecer orden""";

  /// ```dart
  /// "Orden personalizado restablecido"
  /// ```
  String get success => """Orden personalizado restablecido""";

  /// ```dart
  /// "Fecha de adición"
  /// ```
  String get basisDateAdded => """Fecha de adición""";

  /// ```dart
  /// "Nombre A–Z"
  /// ```
  String get basisNameAsc => """Nombre A–Z""";
...
class ComposeChecklistsMessagesEs extends ComposeChecklistsMessages {
  ...
  /// "Etiquetas"
  /// ```
  String get chipLabel => """Etiquetas""";
...
class PriceChecklistsMessagesEs extends PriceChecklistsMessages {
  final ChecklistsMessagesEs _parent;
  const PriceChecklistsMessagesEs(this._parent) : super(_parent);

  /// ```dart
  /// "Precio"
  /// ```
  String get label => """Precio""";
...
class MarkdownChecklistsMessagesEs extends MarkdownChecklistsMessages {
  ...
  /// "Importar a"
  /// ```
  String get importToLabel => """Importar a""";
...
class NotesWallMessagesEs extends NotesWallMessages {
  ...
  /// ```dart
  /// "Importar a una lista"
  /// ```
  String get importToList => """Importar a una lista""";

  /// ```dart
  /// "No hay listas disponibles para importar."
  /// ```
...
class RecurrenceMessagesEs extends RecurrenceMessages {
  ...
  /// "Días del mes"
  /// ```
  String get monthlyModeDays => """Días del mes""";

  /// ```dart
  /// "Un día de la semana del mes"
  /// ```
  String get monthlyModeWeekday => """Un día de la semana del mes""";

  /// ```dart
  /// "Déjalo vacío para repetir el mismo día cada mes"
  /// ```
  ...
  /// "Fecha"
  /// ```
  String get yearlyDate => """Fecha""";

  /// ```dart
  /// "Déjalo vacío para repetir la misma fecha cada año"
  /// ```
  ...
  /// "el $days"
  /// ```
  String onTheDays(String days) => """el $days""";

  /// ```dart
  /// "${_plural(count, one: 'el día $days', many: 'los días $days')}"
  /// ```
  ...
  /// "el $date"
  /// ```
  String onYearlyDate(String date) => """el $date""";
  ...
  OrdinalRecurrenceMessagesEs get ordinal => OrdinalRecurrenceMessagesEs(this);
  OrdinalInlineRecurrenceMessagesEs get ordinalInline =>
      OrdinalInlineRecurrenceMessagesEs(this);
}
...
class OrdinalRecurrenceMessagesEs extends OrdinalRecurrenceMessages {
  final RecurrenceMessagesEs _parent;
  const OrdinalRecurrenceMessagesEs(this._parent) : super(_parent);
...
class OrdinalInlineRecurrenceMessagesEs
    extends OrdinalInlineRecurrenceMessages {
  final RecurrenceMessagesEs _parent;
  const OrdinalInlineRecurrenceMessagesEs(this._parent) : super(_parent);
...
class MarkdownEditorMessagesEs extends MarkdownEditorMessages {
  final MessagesEs _parent;
  const MarkdownEditorMessagesEs(this._parent) : super(_parent);
  ...
  /// "Texto enriquecido"
  /// ```
  String get editRich => """Texto enriquecido""";
}

class WearMessagesEs extends WearMessages {
  final MessagesEs _parent;
  const WearMessagesEs(this._parent) : super(_parent);

  /// ```dart
  /// "Sesión iniciada como ${name}"
  /// ```
  String signedInAs(String name) => """Sesión iniciada como ${name}""";
  ...
  /// ```
  String get emptyNote => """Esta nota está vacía""";
...
Por favor, completa el inicio de sesión en tu navegador.""",
  ...
  """onboarding.progressHeroDismissBody""":
      """¿No necesitas el anillo de progreso arriba? Pulsa la X en la tarjeta para ocultarla.""",
  """onboarding.widgetListsTitle""": """Elige las listas de tu widget""",
  """onboarding.widgetListsBody""":
      """Añade el widget de Pantry a tu pantalla de inicio para ver de un vistazo cuántos artículos quedan en cada lista, sin abrir la app.""",
  """onboarding.widgetListsActionLabel""": """Elegir listas""",
  """onboarding.widgetListsWidgetTitle""": """Pantry""",
  """onboarding.widgetListsWidgetEmpty""": """Todo hecho""",
...
Contraseña: pantry-rocks""",
  ...
  """onboarding.priceTitle""": """Añade precios a tus artículos""",
  ...
  """onboarding.categoryScopeTitle""": """Categorías por lista""",
  ...
  """settings.shoppingRefresh""": """Modo compra""",
  """settings.refreshOff""": """Desactivado""",
  """settings.refreshInherit""": """Igual que las listas""",
  """settings.refresh15s""": """Cada 15 segundos""",
  """settings.refresh30s""": """Cada 30 segundos""",
  ...
  """categories.deleteConfirmBody""":
      """Los artículos en esta categoría quedarán sin categoría. Esta acción no se puede deshacer.""",
  """categories.list""": """Lista""",
  """categories.globalList""": """Todas las listas (global)""",
  ...
  """stores.sort.nameAZ""": """Nombre A–Z""",
  """stores.sort.nameZA""": """Nombre Z–A""",
  """stores.sort.custom""": """Personalizado""",
  """labels.manageTitle""": """Gestionar etiquetas""",
  """labels.noLabels""": """Aún no hay etiquetas.""",
  """labels.editTitle""": """Editar etiqueta""",
  """labels.addTitle""": """Nueva etiqueta""",
  """labels.name""": """Nombre""",
  """labels.icon""": """Icono""",
  """labels.color""": """Color""",
  """labels.saveFailed""": """No se pudo guardar la etiqueta.""",
  """labels.deleteFailed""": """No se pudo eliminar la etiqueta.""",
  """labels.deleteConfirm""": """¿Eliminar esta etiqueta?""",
  """labels.deleteConfirmBody""":
      """Esta etiqueta se eliminará de todos los artículos. Esto no se puede deshacer.""",
  """labels.list""": """Lista""",
  """labels.globalList""": """Todas las listas (global)""",
  """labels.sort.nameAZ""": """Nombre A–Z""",
  """labels.sort.nameZA""": """Nombre Z–A""",
  """labels.sort.custom""": """Personalizado""",
  ...
  """checklists.filters.labels""": """Etiquetas""",
  ...
  """checklists.filters.allLabels""": """Todas las etiquetas""",
  """checklists.filters.noCategory""": """Sin categoría""",
  """checklists.filters.noStores""": """Sin tienda""",
  """checklists.filters.noLabels""": """Sin etiqueta""",
  """checklists.filters.price""": """Precio""",
  """checklists.filters.anyCurrency""": """Cualquier moneda""",
  ...
  """checklists.batch.labelsTitle""": """Establecer etiquetas""",
  ...
  """checklists.batch.labels""": """Etiquetas""",
  ...
  """checklists.itemForm.labels""": """Etiquetas""",
  """checklists.itemForm.noLabels""": """Ninguna""",
  """checklists.itemForm.createLabel""": """Nueva etiqueta""",
  """checklists.itemForm.labelsChange""": """Cambiar""",
  """checklists.itemForm.labelsPick""": """Elegir""",
  ...
  """checklists.sort.store""": """Por tienda""",
  ...
  """checklists.uncheckAll""": """Desmarcar todo""",
  ...
  """checklists.resetOrder.confirmBody""":
      """Esto sobrescribe el orden personalizado actual de esta lista. Puedes reordenar los artículos después.""",
  """checklists.resetOrder.action""": """Restablecer orden""",
  """checklists.resetOrder.success""": """Orden personalizado restablecido""",
  """checklists.resetOrder.basisDateAdded""": """Fecha de adición""",
  """checklists.resetOrder.basisNameAsc""": """Nombre A–Z""",
  """checklists.resetOrder.basisNameDesc""": """Nombre Z–A""",
  ...
  """checklists.compose.multipleHint""":
      """Separa los elementos con saltos de línea""",
  """checklists.price.label""": """Precio""",
  """checklists.price.set""": """Fijo""",
  """checklists.price.range""": """Rango""",
  """checklists.price.amount""": """Importe""",
  """checklists.price.min""": """Mín""",
  ...
  """checklists.markdown.importToLabel""": """Importar a""",
  ...
  """recurrence.monthlyModeDays""": """Días del mes""",
  """recurrence.monthlyModeWeekday""": """Un día de la semana del mes""",
  """recurrence.monthDaysHint""":
      """Déjalo vacío para repetir el mismo día cada mes""",
  """recurrence.yearlyDate""": """Fecha""",
  """recurrence.yearlyDateHint""":
      """Déjalo vacío para repetir la misma fecha cada año""",
  """recurrence.pickDate""": """Elegir fecha""",
  ...
  """recurrence.ordinal.first""": """Primero""",
  """recurrence.ordinal.second""": """Segundo""",
  """recurrence.ordinal.third""": """Tercero""",
  """recurrence.ordinal.fourth""": """Cuarto""",
  """recurrence.ordinal.last""": """Último""",
  """recurrence.ordinalInline.first""": """primer""",
  """recurrence.ordinalInline.second""": """segundo""",
  """recurrence.ordinalInline.third""": """tercer""",
  """recurrence.ordinalInline.fourth""": """cuarto""",
  """recurrence.ordinalInline.last""": """último""",
  ...
  """wear.emptyNote""": """Esta nota está vacía""",
