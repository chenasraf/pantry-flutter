...
class StoresMessages {
  final Messages _parent;
  const StoresMessages(this._parent);

  /// ```dart
  /// "Manage stores"
  /// ```
  String get manageTitle => """Manage stores""";
  ...
  /// "Edit store"
  /// ```
  String get editTitle => """Edit store""";

  /// ```dart
  /// "New store"
  /// ```
  String get addTitle => """New store""";
  ...
  /// ```
  String get saveFailed => """Failed to save store.""";

  /// ```dart
  /// "Failed to delete store."
  /// ```
  String get deleteFailed => """Failed to delete store.""";

  /// ```dart
  /// "Delete this store?"
  /// ```
  String get deleteConfirm => """Delete this store?""";
...
class ChecklistsMessages {
  ...
  FiltersChecklistsMessages get filters => FiltersChecklistsMessages(this);
  ...
  /// ```
  String get allListsSubtitle => """Items from every list""";

  /// ```dart
  /// "Add an item…"
  /// ```
  String get addToAnyList => """Add an item…""";
...
class FiltersChecklistsMessages {
  final ChecklistsMessages _parent;
  const FiltersChecklistsMessages(this._parent);
...
class ItemFormChecklistsMessages {
  ...
  /// "None"
  /// ```
  String get noStores => """None""";

  /// ```dart
  /// "New store"
  /// ```
  String get createStore => """New store""";

  /// ```dart
  /// "Change"
  /// ```
  String get storesChange => """Change""";
...
class ComposeChecklistsMessages {
  ...
  /// "List"
  /// ```
  String get chipTargetList => """List""";
...
class RecurrenceMessages {
  ...
  /// "Days of the month"
  /// ```
  String get monthlyModeDays => """Days of the month""";

  /// ```dart
  /// "A weekday of the month"
  /// ```
  String get monthlyModeWeekday => """A weekday of the month""";

  /// ```dart
  /// "Leave empty to repeat on the same day each month"
  /// ```
  ...
  /// ```dart
  /// "Leave empty to repeat on the same date each year"
  /// ```
  ...
  /// "on the $days"
  /// ```
  String onTheDays(String days) => """on the $days""";

  /// ```dart
  /// "${_plural(count, one: 'on day $days', many: 'on days $days')}"
  /// ```
  ...
  /// "on $date"
  /// ```
  String onYearlyDate(String date) => """on $date""";
  ...
  OrdinalRecurrenceMessages get ordinal => OrdinalRecurrenceMessages(this);
  OrdinalInlineRecurrenceMessages get ordinalInline =>
      OrdinalInlineRecurrenceMessages(this);
}
...
class OrdinalRecurrenceMessages {
  final RecurrenceMessages _parent;
  const OrdinalRecurrenceMessages(this._parent);
...
class OrdinalInlineRecurrenceMessages {
  final RecurrenceMessages _parent;
  const OrdinalInlineRecurrenceMessages(this._parent);
...
class WearMessages {
  final Messages _parent;
  const WearMessages(this._parent);
  ...
  /// ```
  String get emptyNote => """Nothing in this note""";
  ...
  /// "Undo"
  /// ```
  String get undoWindow => """Undo""";

  /// ```dart
  /// "Off"
  /// ```
  String get undoOff => """Off""";
...
Password: pantry-rocks""",
  ...
  """checklists.itemForm.categoryCreateFailed""":
      """Failed to create category.""",
  """checklists.itemForm.stores""": """Stores""",
  """checklists.itemForm.noStores""": """None""",
  ...
  """recurrence.monthlyModeDays""": """Days of the month""",
  """recurrence.monthlyModeWeekday""": """A weekday of the month""",
  """recurrence.monthDaysHint""":
      """Leave empty to repeat on the same day each month""",
  """recurrence.yearlyDate""": """Date""",
  """recurrence.yearlyDateHint""":
      """Leave empty to repeat on the same date each year""",
  """recurrence.pickDate""": """Pick a date""",
  ...
  """recurrence.ordinalInline.first""": """first""",
  """recurrence.ordinalInline.second""": """second""",
  """recurrence.ordinalInline.third""": """third""",
  """recurrence.ordinalInline.fourth""": """fourth""",
  """recurrence.ordinalInline.last""": """last""",
  ...
  """wear.emptyNote""": """Nothing in this note""",
